    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 flex flex-col items-center justify-center max-w-5xl mx-auto px-4 py-16 sm:py-24 text-center relative">
        ...
        <div className="relative z-10 flex flex-col items-center max-w-3xl">
          ...
          {/* Heading */}
          <h1 className="text-4xl sm:text-6xl font-black text-white leading-tight tracking-tight mb-6 animate-slide-up">
          ...
          <p className="text-gray-400 text-lg sm:text-xl font-medium mb-12 max-w-2xl leading-relaxed animate-slide-up">
            ...
            <form onSubmit={handleJoin} className="flex flex-col gap-4">
              <FormField error={error || undefined} label="">
                <Input
                  ...
                  className="text-center text-2xl font-black tracking-widest py-4 border-violet-500/20 bg-gray-950/40 focus:border-violet-500"
                  fullWidth
                />
              </FormField>
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 animate-slide-up">
            <span className="text-sm font-semibold text-gray-500">Want to host your own quiz?</span>
            <Button
              variant="outline"
              size="sm"
              onClick={() => router.push('/dashboard')}
              className="border-gray-800 hover:border-violet-500/40 text-violet-300"
            >
      ...
      {/* Footer */}
      <footer className="w-full border-t border-gray-900 bg-gray-950/20 py-6 text-center text-xs text-gray-600 font-bold select-none">
