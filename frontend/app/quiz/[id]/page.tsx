    ...
    return (
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-4">
          <div className="glass-panel text-center p-8 rounded-3xl max-w-md w-full border border-gray-800">
    ...
    return (
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-4 relative py-12">
          ...
          <div className="glass-panel max-w-md w-full p-8 rounded-3xl border border-violet-500/15 text-center animate-scale-in relative z-10">
    ...
    return (
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center max-w-md mx-auto px-4 text-center">
          <div className="glass-panel p-8 rounded-3xl border border-violet-500/10 w-full animate-scale-in">
            ...
            <div className="bg-violet-950/20 border border-violet-500/15 py-3 px-5 rounded-2xl mb-8 flex items-center justify-center gap-3">
        ...
        <div className="flex-1 max-w-3xl w-full mx-auto px-4 py-8 flex flex-col gap-6 select-none">
          ...
          <div className="flex justify-between items-center gap-4">
            ...
            <div className="text-right">
              <span className="text-xs text-gray-400 font-bold block">Score</span>
          ...
          {!isAnswerLocked && (
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-center px-1 font-bold text-xs text-gray-400 uppercase tracking-widest">
                <span>Timer Countdown</span>
                <span className={timeLeft <= 5 ? 'text-red-400 animate-pulse' : 'text-violet-400'}>
                  {timeLeft}s
                </span>
              </div>
              <ProgressBar
          ...
          {/* Question Text */}
          <div className="glass-panel p-8 rounded-3xl border border-violet-500/15 text-center mt-2">
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-4 py-12 relative">
          ...
          <div className="glass-panel max-w-md w-full p-8 rounded-3xl border border-violet-500/15 text-center animate-scale-in relative z-10">
            ...
            {/* Rank highlight */}
            <div className="bg-violet-950/20 border border-violet-500/15 p-6 rounded-2xl mb-6">
              <span className="text-xs font-black text-gray-500 uppercase tracking-widest block mb-1">Your Rank</span>
              <h3 className="text-4xl font-black text-violet-300 tracking-tight">
                {rankLabel}
              </h3>
            </div>
            ...
            <div className="flex flex-col gap-3.5 mb-8 text-left">
              <div className="flex justify-between items-center py-2 border-b border-gray-800/60">
                <span className="text-sm text-gray-400 font-semibold">Total Points</span>
                <span className="text-lg font-black text-white">{totalScore.toLocaleString()} PTS</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-gray-800/60">
                <span className="text-sm text-gray-400 font-semibold">Accuracy</span>
                <span className="text-sm font-bold text-white">
                  {correctCount} / {totalQuestions} correct ({totalQuestions > 0 ? Math.round((correctCount / totalQuestions) * 100) : 0}%)
                </span>
              </div>
              <div className="flex justify-between items-center py-2">
                <span className="text-sm text-gray-400 font-semibold">Nickname</span>
    ...
    <div className="min-h-screen flex flex-col bg-[#0B0F19]">
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-gray-400 text-sm font-semibold">Loading live game lobby...</p>
        </div>
      </div>
    </div>
  );
